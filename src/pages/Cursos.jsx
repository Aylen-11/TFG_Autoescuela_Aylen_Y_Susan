...
function Cursos() {
  ...
  useEffect(() => {
    ...
    if (category) {
      ...
      if (category === 'recuperacion') {
        setSelectedCourse('recuperacion');
  ...
  const permisosInfoRecuperacion = {
    recuperacion: {
      ...
      caracteristicas: [
        "Recuperación Parcial: hasta 4 puntos en 10 horas",
        "Recuperación Total: hasta 8 puntos en 20 horas",
        "Cursos homologados por la DGT",
        "Modalidad presencial en centros autorizados",
        "Solo un curso cada 2 años (1 año para profesionales)",
        "Examen final en la modalidad total",
      ],
    },
  };
  ...
  const buyNow = (item) => { addToCart(item); setShowCart(true); };

  const getTotalCart = () => cart.reduce((sum, item) => sum + item.total, 0);
      ...
      <nav className="navbar-top">
        <div className="promo-container">
          <div className="promo-track">
            <span className="promo-text">MATRÍCULAS ABIERTAS • CLASES PRÁCTICAS • APROBADOS GARANTIZADOS • INSCRÍBETE HOY • TENEMOS LOS MEJORES PRECIOS • LOS MEJORES PROFESORES • SACA TU CARNET A LA PRIMERA</span>
            <span className="promo-text">• MATRÍCULAS ABIERTAS • CLASES PRÁCTICAS • APROBADOS GARANTIZADOS • INSCRÍBETE HOY • TENEMOS LOS MEJORES PRECIOS • LOS MEJORES PROFESORES • SACA TU CARNET A LA PRIMERA</span>
          </div>
        </div>
      </nav>
  ...
  if (selectedPackage && selectedCourse) {
    ...
    const esRecuperacion = selectedCourse === 'recuperacion';
          ...
          <div className="pd-product-card">
            ...
            <div className="pd-right-col">
              ...
              <div className="pd-total-row">
                ...
                <span className="pd-total-value">{packageData.price + (extraClass && !esRecuperacion ? 25 : 0)}€</span>
              </div>
    ...
    return (
      <div className="cursos-container">
        ...
        <div className="course-detail-page">
          <button className="back-button" onClick={() => { setSelectedCourse(null); setSelectedCarnet(null); }}>← Volver a categorías</button>
